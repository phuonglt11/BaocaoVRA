function HOGFeatureKNN()
%% Load Image Information from AnimalData Directory
...
MdKNN = fitcknn(trainingFeatures,trainingLabel);
...
predictedLabels = predict(MdKNN,testFeatures);
